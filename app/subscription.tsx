...
const PLANS: Plan[] = [
  {
    ...
    features: [
      { icon: MessageSquare, text_ar: '١٥ رسالة يومياً',       text_en: '15 messages/day'      },
      { icon: Brain,         text_ar: 'ذاكرة ٣ أيام',           text_en: '3-day memory'          },
      { icon: Search,        text_ar: 'بحث وطقس وأخبار',        text_en: 'Search, weather, news' },
      { icon: Globe,         text_ar: 'ترجمة وتلخيص',           text_en: 'Translate & summarize' },
      { icon: GraduationCap, text_ar: 'مذاكرة (مرة/يوم)',       text_en: 'Study (1x/day)'        },
      { icon: Code2,         text_ar: 'برمجة أساسية',           text_en: 'Basic coding'          },
      { icon: TrendingUp,    text_ar: 'تحليل أعمال (مرة/يوم)', text_en: 'Business (1x/day)'     },
      { icon: Heart,         text_ar: 'مدرب حياة (مرة/يوم)',   text_en: 'Life Coach (1x/day)'   },
      { icon: Moon,          text_ar: 'تفسير أحلام (مرة/يوم)', text_en: 'Dreams (1x/day)'       },
      { icon: Mic,           text_ar: 'صوت Edge TTS',           text_en: 'Edge TTS Voice'        },
      { icon: Zap,           text_ar: 'إعلانات للطاقة',         text_en: 'Ads for energy'        },
    ],
  },
  {
    id: 'plus', name: 'Plus', price: '$5.99', period: '/شهر',
    billingNote: 'تدفع شهرياً',
    ...
    features: [
      { icon: MessageSquare, text_ar: '٥٠ رسالة يومياً',       text_en: '50 messages/day'         },
      { icon: Brain,         text_ar: 'ذاكرة ٣٠ يوم',          text_en: '30-day memory'            },
      { icon: GraduationCap, text_ar: 'مذاكرة (١٥/يوم)',       text_en: 'Study (15x/day)'          },
      { icon: Code2,         text_ar: 'مختبر برمجة (٥/يوم)',   text_en: 'Code Lab (5x/day)'        },
      { icon: TrendingUp,    text_ar: 'تحليل أعمال (٥/يوم)',   text_en: 'Business (5x/day)'        },
      { icon: Heart,         text_ar: 'مدرب حياة (٣/يوم)',     text_en: 'Life Coach (3x/day)'      },
      { icon: ImageIcon,     text_ar: 'إنشاء صور (٣/يوم)',     text_en: 'Image creation (3x/day)'  },
      { icon: Home,          text_ar: 'منزل ذكي متقدم',         text_en: 'Advanced Smart Home'      },
      { icon: Zap,           text_ar: 'بدون إعلانات',           text_en: 'No ads'                   },
    ],
  },
  {
    id: 'premium', name: 'Premium', price: '$14.99', period: '/شهر',
    billingNote: 'تدفع شهرياً',
    ...
    features: [
      { icon: MessageSquare, text_ar: '١٥٠ رسالة يومياً',      text_en: '150 messages/day'         },
      { icon: Brain,         text_ar: 'ذاكرة ٩٠ يوم',          text_en: '90-day memory'             },
      { icon: GraduationCap, text_ar: 'مذاكرة (٥٠/يوم)',       text_en: 'Study (50x/day)'           },
      { icon: Code2,         text_ar: 'مختبر برمجة (٣٠/يوم)',  text_en: 'Code Lab (30x/day)'        },
      { icon: ImageIcon,     text_ar: 'إنشاء صور (١٥/يوم)',    text_en: 'Image creation (15x/day)'  },
      { icon: Mic,           text_ar: 'صوت ElevenLabs',         text_en: 'ElevenLabs Voice'          },
      { icon: Brain,         text_ar: 'وضع الظل الذكي',         text_en: 'Shadow Mode'               },
      { icon: Cloud,         text_ar: 'بحث عميق بالذكاء',       text_en: 'AI Deep Search'            },
    ],
  },
  {
    id: 'pro', name: 'Pro', price: '$110', period: '/٦ أشهر',
    billingNote: 'تدفع كل ٦ أشهر (وفر ٣٠٪)',
    ...
    features: [
      { icon: MessageSquare, text_ar: '٥٠٠ رسالة يومياً',      text_en: '500 messages/day'          },
      { icon: Brain,         text_ar: 'ذاكرة سنة كاملة',        text_en: '1-year memory'             },
      { icon: Infinity,      text_ar: 'كل الميزات بلا حدود',    text_en: 'All features unlimited'    },
      { icon: Mic,           text_ar: 'صوت ElevenLabs فاخر',    text_en: 'Premium ElevenLabs Voice'  },
      { icon: Star,          text_ar: 'دعم VIP مباشر',           text_en: 'Direct VIP Support'        },
    ],
  },
  {
    id: 'yearly', name: 'Yearly', price: '$199', period: '/سنة',
    billingNote: 'تدفع سنوياً (وفر ٤٥٪)',
    ...
    features: [
      { icon: MessageSquare, text_ar: 'رسائل غير محدودة',       text_en: 'Unlimited messages'        },
      { icon: Brain,         text_ar: 'ذاكرة دائمة',             text_en: 'Permanent memory'          },
      { icon: Infinity,      text_ar: 'كل الميزات ∞',            text_en: 'All features ∞'            },
      { icon: Brain,         text_ar: 'وعي استباقي كامل',         text_en: 'Full Proactive Awareness'  },
      { icon: Crown,         text_ar: 'أولوية في كل شيء',         text_en: 'Priority in everything'    },
    ],
  },
];
...
export default function SubscriptionScreen() {
  ...
  useEffect(() => {
    let mounted = true;
    initializeIAP().then(ok => { if (mounted) setIapReady(ok); });
  ...
  const handleSubscribe = useCallback(async (plan: Plan) => {
    ...
    try {
      ...
      if (result.message === 'cancelled' || result.message === 'timeout') return;
  ...
  const handleRestore = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert(isAr ? 'خطأ' : 'Error', t.restoreFail);
    } finally {
      setIsRestoring(false);
    }
  }, [isRestoring, iapReady, userId, isAr, t, openWebFallback]);
            ...
            <View key={plan.id} style={[
              ...
              <View style={st.planHeader}>
                <View style={[st.planIconWrap, { backgroundColor: plan.glowColor }]}>
                  <PlanIcon size={26} stroke={plan.color} />
                </View>
              ...
              {plan.billingNote
                ? <Text style={[st.billingNote, { color: colors.success }]}>{plan.billingNote}</Text>
                : null}
                ...
                {plan.features.map((f, i) => {
                  ...
                  return (
                    <View key={i} style={st.featureRow}>
                      <Icon size={14} stroke={colors.success} />
                      <Text style={[st.featureText, { color: colors.subtext }]}>
                ...
                {isLoading
                  ...
                  : <>
                      ...
                      {!isCurrent && plan.id !== 'free' && (
                        <ArrowRight size={16} stroke="#FFF" style={{ marginLeft: 6 }} />
                      )}
                    </>
                }
              </TouchableOpacity>
        ...
        <TouchableOpacity style={st.restoreBtn} onPress={handleRestore} disabled={isRestoring}>
          {isRestoring
            ...
            : <View style={st.restoreInner}>
                <RefreshCw size={14} stroke={colors.accent} />
...
const st = StyleSheet.create({
  ...
  heroIcon:     { width: 70, height: 70, borderRadius: 20, justifyContent: 'center', alignItems: 'center', marginBottom: 14 },
  heroTitle:    { fontSize: 22, fontWeight: '800', textAlign: 'center', marginBottom: 8 },
  heroSub:      { fontSize: 13, textAlign: 'center', lineHeight: 20, paddingHorizontal: 10 },
  planCard:     { borderRadius: 22, padding: 18, marginBottom: 14, position: 'relative' },
  ...
  planName:     { fontSize: 19, fontWeight: '800', marginBottom: 2 },
  planTagline:  { fontSize: 11, fontWeight: '600', fontStyle: 'italic' },
  priceRow:     { flexDirection: 'row', alignItems: 'baseline', gap: 4, marginBottom: 4 },
  price:        { fontSize: 32, fontWeight: '800' },
  period:       { fontSize: 14 },
  billingNote:  { fontSize: 11, fontWeight: '600', marginBottom: 14 },
  consciousnessRow:   { flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: 16 },
  consciousnessLabel: { fontSize: 11, fontWeight: '600', flex: 1 },
  consciousnessBar:   { flexDirection: 'row', gap: 3, flex: 1 },
  consciousnessSeg:   { flex: 1, height: 5, borderRadius: 3 },
  featuresList:     { marginBottom: 6 },
  featureRow:       { flexDirection: 'row', alignItems: 'flex-start', gap: 7, marginBottom: 5 },
  featureText:      { fontSize: 12, lineHeight: 18, flex: 1 },
  subscribeBtn:     { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 13, borderRadius: 14, marginTop: 12 },
  ...
  footerNote:   { textAlign: 'center', fontSize: 11, marginTop: 8, marginBottom: 10 },
});
